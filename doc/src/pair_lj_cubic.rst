...
Example input scripts available: examples/PACKAGES/gjf/in.gjf.vfull, examples/PACKAGES/gjf/in.gjf.vhalf, examples/PACKAGES/shock/hugoniostat/in.hugoniostat
