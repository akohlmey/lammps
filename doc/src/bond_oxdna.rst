...
``examples/PACKAGES/cgdna/examples``, A simple python setup tool which
creates single straight or helical DNA strands, DNA/RNA duplexes or
arrays of DNA/RNA duplexes can be found in
